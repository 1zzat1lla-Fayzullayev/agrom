  ...
  return (
    <>
      <Helmet>
        {/* SEO */}
        <title>
          Производитель концентрированных пюре (концентратов), сушеных овощей и
          фруктов - Agrom
        </title>
        <meta
          name="description"
          content="Agrom is a leading manufacturer of natural concentrates, dried fruits, and vegetables. Explore our 100% natural products sourced directly from Uzbekistan. Affordable pricing and fast delivery."
        />
        <meta
          name="keywords"
          content="concentrated puree, dried vegetables, dried fruits, natural products, Uzbekistan, wholesale, tomato paste, apricot puree, dried apples, carrot puree, pumpkin puree, pepper, parsley, dried plums, концентрированное пюре, сушеные овощи, сухофрукты, натуральные продукты, Узбекистан, оптом, томатная паста, абрикосовое пюре, сушеные яблоки, морковное пюре, тыквенное пюре, перец, петрушка, чернослив"
        />

        <meta property="og:title" content="Agrom - Натуральные концентраты и сухофрукты" />
        <meta
          property="og:description"
          content="Discover our range of 100% natural dried fruits, vegetables, and concentrated purees from Uzbekistan."
        />
